 ...
 * @version 1.0
 */
public class AdditiveInfModel_neighbeta {
	...
	public AdditiveInfModel_neighbeta(String confPath){
...
//				System.out.println("$$$$$$$$Waiting for loss calculating$$$$$$$$");
	...
	class UCCalculator implements Runnable {
		...
		private void calcDeltaUC(Integer calcId) {
			...
			//derivative to Ci is Ci*||Ui||/||Ci|| - Ui
		...
		private void missionOver() {
			...
			AdditiveInfModel_neighbeta.missionOver();
		}
	...
	public static void main(String[] args) {
		...
		AdditiveInfModel_neighbeta nb = new AdditiveInfModel_neighbeta(args[0]);
		try {
			nb.learningProc();
		} catch (IOException e) {
